...
Anthropic-intern gemessen: XML-strukturierte Prompts liefern nachweislich konsistentere Ergebnisse *(bis zu 40% Halluzinationsreduktion — Community-Erfahrungswert, nicht offiziell belegt)*.
...
| XML-Tags für komplexe Prompts | nachweislich bessere Ergebnisse *(Community-Erfahrungswert)* |
