...
**How to find it:**
```
claude.ai → click your profile icon (bottom left)
→ "Settings" → "Profile"
→ Field: "What preferences should Claude consider in responses?"
```
...
**The secret of project instructions:**  
...
**Comparison: With and without XML tags**
...
**Anthropic data:** Structured prompts with XML tags deliver 20–40% more consistent results than unstructured text.
...
**Why this works:** Claude learned from the writing of millions of experts. A precise role activates the right patterns — vocabulary, caution level, depth of explanation.
...
**The solution:** Tell Claude what NOT to do. That's more effective than telling it what to do.
...
- 📅 Events after August 2025 (knowledge cutoff)
...
```
If this information might be outdated after August 2025:
...
| 2 | XML tags for complex prompts | 20–40% better results |
