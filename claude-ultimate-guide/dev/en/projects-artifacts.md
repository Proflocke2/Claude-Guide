...
> **Common misconception:** "500K context is Enterprise-only" is wrong. Per Anthropic's support docs, 500K is available on **all paid plans** (confirmed via Anthropic support docs) when chatting with Opus 4.6+/Sonnet 4.6.
