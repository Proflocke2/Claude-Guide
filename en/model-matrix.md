...
> Current as of June 2026. Deprecated IDs retire June 15, 2026.
...
| `claude-haiku-4-5` | 200K tokens | 64K | — | $1 / $5 per MTok |

**Batch API:** Flat 50% discount on all calls; extends max output to 300K on Opus 4.6+/Sonnet 4.6 via `output-300k-2026-03-24` beta header. No quality difference for non-real-time workloads.
...
│        84% on OnlineMind2Web computer use)
│
...
| Computer use (OSWorld-Verified) | 84% | 61.4% | ✅ Supported |
...
effort_map = {
    "simple_qa": "low",          # fast, minimal reasoning
    "standard_coding": "medium",
    "complex_analysis": "high",  # default for Opus 4.6+
    "frontier_agent": "max",     # Opus 4.8 only
    # "xhigh" available in Claude Code only
}
...
|---|---|---|---|
| `claude-sonnet-4-20250514` | ❌ Retired June 15, 2026 | `claude-sonnet-4-6` | $3 / $15 |
| `claude-opus-4-20250514` | ❌ Retired June 15, 2026 | `claude-opus-4-8` | $15 / $75 |
| `claude-3-5-haiku-20241022` | ❌ Already retired | `claude-haiku-4-5` | $0.80–$1 / $4 |
...
> **Context window clarification:** "500K context is Enterprise-only" is incorrect. Per Anthropic's support docs, 500K is available **on all paid plans** for Opus 4.6+/Sonnet 4.6 in chat. The Team plan's marketing page showing "200K" is outdated — the dedicated context-window support article is authoritative.
