...
**Critical ordering rule:** `tool_result` blocks must come **before** any `text` blocks in the user message. Text-before-tool-result returns a 400 error.
...
| `computer_use` | Desktop control (61.4%–84% OSWorld-Verified on Sonnet 4.5+/4.6) | Included |
...
- **20–40% token savings** for requests with 10–49 tools
