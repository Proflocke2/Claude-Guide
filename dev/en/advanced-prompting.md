...
> Anthropic measured it: XML-structured prompts produce **measurably more consistent outputs (Anthropic documents up to 40% hallucination reduction in internal tests)** than unstructured equivalents.
