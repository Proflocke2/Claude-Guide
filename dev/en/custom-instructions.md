...
Cache economics:
- Cache reads at **0.1×** base input price *(→ [Prompt caching](https://platform.claude.com/docs/en/build-with-claude/prompt-caching))*
...
| One-shot without examples | less consistent output *(20–40% — community experience value)* | Add 3–5 structured `<examples>` |
