...
**Cache-Ökonomie:**
- Cache-Lesevorgänge bei **0,1×** des Basis-Input-Preises *(→ [Prompt caching](https://platform.claude.com/docs/en/build-with-claude/prompt-caching))*
...
| One-Shot ohne Beispiele | weniger konsistenter Output *(20–40% — Community-Erfahrungswert)* | 3–5 strukturierte `<examples>` hinzufügen |
