...
| `claude-haiku-4-5-20251001` | 200K Token | 64K | — | $1 / $5 pro MTok |

Batch API: Pauschal 50% Rabatt *(→ [Batch API](https://platform.claude.com/docs/en/build-with-claude/batch-api))* auf alle Aufrufe; verlängert Max-Output auf 300K bei Opus 4.6+/Sonnet 4.6 via `output-300k-2026-03-24` Beta-Header. Kein Qualitätsunterschied für nicht-echtzeitkritische Workloads.
...
│        84% auf Online-Mind2Web (83,4% OSWorld-Verified) für Computer Use)
│
...
| Computer Use (OSWorld-Verified / Mind2Web) | 83,4% / 84% | 72,5% | ✅ Unterstützt |
...
effort_karte = {
    ...
    "komplexe_analyse": "high",
    "coding_agent": "xhigh",      # Empfohlen für Coding/Agentic auf Opus 4.7+
...
response = client.messages.create(
    ...
    max_tokens=4096,
    thinking={"type": "adaptive"},        # adaptive, nicht "enabled"
    output_config={"effort": "high"},     # effort gehört in output_config
    messages=[...]
)
```
...
Hinweis: ~$13/Entwickler/aktivem Tag *(Community-Erfahrungswert, nicht offiziell von Anthropic belegt)*
...
|---|---|---|---|
| `claude-sonnet-4-20250514` | ❌ [Pensioniert 15. Juni 2026](https://platform.claude.com/docs/en/about-claude/model-deprecations) | `claude-sonnet-4-6` | $3 / $15 |
| `claude-opus-4-20250514` | ❌ Pensioniert 15. Juni 2026 | `claude-opus-4-8` | $15 / $75 |
| `claude-3-5-haiku-20241022` | ❌ Bereits pensioniert | `claude-haiku-4-5-20251001` | $0,80–$1 / $4 |

> **Opus 4.8 ($5/$25) bedeutet eine 67% Preissenkung *(→ [Pricing](https://platform.claude.com/docs/en/about-claude/pricing))* gegenüber Opus 4 ($15/$75)** — die größte Kostenreduktion in der Claude-4.x-Familie.
